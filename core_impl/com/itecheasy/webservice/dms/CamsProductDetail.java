...
/**
 * <p>Java class for camsProductDetail complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="camsProductDetail">
 *   &lt;complexContent>
 ...
 *         &lt;element name="productPictures" type="{http://cams.communication.itecheasy.com/}productPicture" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="productPropertyValues" type="{http://cams.communication.itecheasy.com/}camsProductPropertyValueBind" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "camsProductDetail", propOrder = {
    "availableStock",
    "category1Name",
    "category2Name",
    "category3Name",
...
public class CamsProductDetail {
    ...
    @XmlElement(nillable = true)
    protected List<CamsProductPropertyValueBind> productPropertyValues;
     ...
     * This is why there is not a <CODE>set</CODE> method for the productPictures property.
     * 
     * <p>
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the productPropertyValues property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CamsProductPropertyValueBind }
     * 
     * 
     */
    public List<CamsProductPropertyValueBind> getProductPropertyValues() {
        if (productPropertyValues == null) {
            productPropertyValues = new ArrayList<CamsProductPropertyValueBind>();
        }
