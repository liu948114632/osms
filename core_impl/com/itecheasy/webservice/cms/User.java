 ...
 *         &lt;element name="subjectionId" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlType(name = "user", propOrder = { "code", "departmentId", "email", "englishName", "id", "isValid", "name",
		"subjectionId", "userType" })
public class User {
	 ...
	 * 
	 */
	public void setSubjectionId(int value) {
