...
@XmlType(name = "category", propOrder = { "description", "hsCode", "id", "invoiceCnName", "invoiceEnName", "level",
		"name", "packageVolumeRate", "parentID", "type", "volumeRate", "weightRate" })
public class Category {
	...
	/**
	 * Gets the value of the packageVolumeRate property.
	 * 
	...
	/**
	 * Sets the value of the packageVolumeRate property.
	 * 
	 * @param value
