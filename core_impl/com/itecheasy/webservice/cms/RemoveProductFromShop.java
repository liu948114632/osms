...
/**
 * <p>
 * Java class for removeProductFromShop complex type.
 * 
 * <p>
...
@XmlType(name = "removeProductFromShop", propOrder = { "productIds", "departmentIds" })
public class RemoveProductFromShop {
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the departmentIds property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
