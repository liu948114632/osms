...
public class OrderWebServiceImpl implements OrderWebService {
	...
	@Override
	public void updateOrder(int orderId, String remark, boolean sendTag, int isQualityInspection, int operator)
			throws BussinessException {
		orderService.updateOrder(orderId, remark, sendTag, isQualityInspection,
