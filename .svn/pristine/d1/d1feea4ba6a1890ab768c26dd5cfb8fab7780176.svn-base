...
/**
 * <p>
 * Java class for getPropertyByCategoryIds complex type.
 * 
 * <p>
...
@XmlType(name = "getPropertyByCategoryIds", propOrder = { "cateIds" })
public class GetPropertyByCategoryIds {
	 ...
	 * <CODE>set</CODE> method for the cateIds property.
	 * 
	 * <p>
