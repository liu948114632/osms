...
/**
 * <p>
 * Java class for getStorageByTypeResponse complex type.
 * 
 * <p>
...
@XmlType(name = "getStorageByTypeResponse", propOrder = { "_return" })
public class GetStorageByTypeResponse {
	 ...
	 * 
	 * @return possible object is {@link BusinessDepartmentStorage }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link BusinessDepartmentStorage }
	 * 
	 */
