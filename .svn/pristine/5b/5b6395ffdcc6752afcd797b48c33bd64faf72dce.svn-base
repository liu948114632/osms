...
//        List<Shop> shops = systemService.getShopsByUserId(amazonAgedReportForm.getOperatorId());
        ...
        PageList<AmazonInventoryAgedReportPO> amazonInventoryAgedReportPOPageList =
                amazonInventoryAgedReportDao.findPageListTrendHql(amazonAgedReportForm, shopList);
    ...
    public void addToClearTracking(List<String> skus, int shopId,int operatorId) {
        ...
        List<AmazonInventoryAgedReportPO> pos = amazonInventoryAgedReportDao.findListByHql(hql,shopId);
