...
/**
 * @Auther: liteng
 * @Date: 2018/8/11 16:21
 * @Description:
 */
@Entity
@Table(name = "amazon_inventory_aged_report_history", schema = "dbo")
public class AmazonInventoryAgedReportHistoryPO {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        AmazonInventoryAgedReportHistoryPO that = (AmazonInventoryAgedReportHistoryPO) o;
        ...
        if (isClearanceItem != null ? !isClearanceItem.equals(that.isClearanceItem) : that.isClearanceItem != null)
            return false;
        if (terminationDate != null ? !terminationDate.equals(that.terminationDate) : that.terminationDate != null)
            return false;
        if (planStockToZeroDate != null ? !planStockToZeroDate.equals(that.planStockToZeroDate) : that.planStockToZeroDate != null)
            return false;
        if (sellOutDate != null ? !sellOutDate.equals(that.sellOutDate) : that.sellOutDate != null) return false;
        if (sellOutStatus != null ? !sellOutStatus.equals(that.sellOutStatus) : that.sellOutStatus != null)
            return false;
        if (backlogAlertWarning != null ? !backlogAlertWarning.equals(that.backlogAlertWarning) : that.backlogAlertWarning != null)
            return false;
        if (isDoingClearance != null ? !isDoingClearance.equals(that.isDoingClearance) : that.isDoingClearance != null)
            return false;
        if (nextClearingPoint != null ? !nextClearingPoint.equals(that.nextClearingPoint) : that.nextClearingPoint != null)
            return false;
        if (avaliableQuantitySellable != null ? !avaliableQuantitySellable.equals(that.avaliableQuantitySellable) : that.avaliableQuantitySellable != null)
            return false;
        ...
        if (qtyWithRemovalsInProgress != null ? !qtyWithRemovalsInProgress.equals(that.qtyWithRemovalsInProgress) : that.qtyWithRemovalsInProgress != null)
            return false;
        if (invAge0To90Days != null ? !invAge0To90Days.equals(that.invAge0To90Days) : that.invAge0To90Days != null)
            return false;
        if (invAge91To180Days != null ? !invAge91To180Days.equals(that.invAge91To180Days) : that.invAge91To180Days != null)
            return false;
        if (invAge181To270Days != null ? !invAge181To270Days.equals(that.invAge181To270Days) : that.invAge181To270Days != null)
            return false;
        if (invAge271To365Days != null ? !invAge271To365Days.equals(that.invAge271To365Days) : that.invAge271To365Days != null)
            return false;
        if (invAge365PlusDays != null ? !invAge365PlusDays.equals(that.invAge365PlusDays) : that.invAge365PlusDays != null)
            return false;
        if (currency != null ? !currency.equals(that.currency) : that.currency != null) return false;
        if (qtyToBeChargedLtsf6Mo != null ? !qtyToBeChargedLtsf6Mo.equals(that.qtyToBeChargedLtsf6Mo) : that.qtyToBeChargedLtsf6Mo != null)
            return false;
        if (projectedLtsf6Mo != null ? !projectedLtsf6Mo.equals(that.projectedLtsf6Mo) : that.projectedLtsf6Mo != null)
            return false;
        if (qtyToBeChargedLtsf12Mo != null ? !qtyToBeChargedLtsf12Mo.equals(that.qtyToBeChargedLtsf12Mo) : that.qtyToBeChargedLtsf12Mo != null)
            return false;
        if (projectedLtsf12Mo != null ? !projectedLtsf12Mo.equals(that.projectedLtsf12Mo) : that.projectedLtsf12Mo != null)
            return false;
        if (unitsShippedLast7Days != null ? !unitsShippedLast7Days.equals(that.unitsShippedLast7Days) : that.unitsShippedLast7Days != null)
            return false;
        if (unitsShippedLast30Days != null ? !unitsShippedLast30Days.equals(that.unitsShippedLast30Days) : that.unitsShippedLast30Days != null)
            return false;
        if (unitsShippedLast60Days != null ? !unitsShippedLast60Days.equals(that.unitsShippedLast60Days) : that.unitsShippedLast60Days != null)
            return false;
        if (unitsShippedLast90Days != null ? !unitsShippedLast90Days.equals(that.unitsShippedLast90Days) : that.unitsShippedLast90Days != null)
            return false;
        ...
        if (lowestPriceNew != null ? !lowestPriceNew.equals(that.lowestPriceNew) : that.lowestPriceNew != null)
            return false;
        if (lowestPriceUsed != null ? !lowestPriceUsed.equals(that.lowestPriceUsed) : that.lowestPriceUsed != null)
            return false;
        if (recommendedAction != null ? !recommendedAction.equals(that.recommendedAction) : that.recommendedAction != null)
            return false;
        if (healthyInventoryLevel != null ? !healthyInventoryLevel.equals(that.healthyInventoryLevel) : that.healthyInventoryLevel != null)
            return false;
        if (recommendedSalesPrice != null ? !recommendedSalesPrice.equals(that.recommendedSalesPrice) : that.recommendedSalesPrice != null)
            return false;
        if (recommendedSaleDurationDays != null ? !recommendedSaleDurationDays.equals(that.recommendedSaleDurationDays) : that.recommendedSaleDurationDays != null)
            return false;
        if (recommendedRemovalvQuantity != null ? !recommendedRemovalvQuantity.equals(that.recommendedRemovalvQuantity) : that.recommendedRemovalvQuantity != null)
            return false;
        if (estimatedCostSavingsOfRemoval != null ? !estimatedCostSavingsOfRemoval.equals(that.estimatedCostSavingsOfRemoval) : that.estimatedCostSavingsOfRemoval != null)
            return false;
        if (sellThrough != null ? !sellThrough.equals(that.sellThrough) : that.sellThrough != null) return false;
        if (cubicFeet != null ? !cubicFeet.equals(that.cubicFeet) : that.cubicFeet != null) return false;
