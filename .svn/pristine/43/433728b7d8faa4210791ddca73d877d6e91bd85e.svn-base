...
public interface FbaInboundWebService {
	 ...
	 * @return
	 */
	public String checkExcel(@WebParam(name = "shopId") int shopId, @WebParam(name = "skus") List<String> skus);
	...
	public List<FbaPreInboundOrderVO> submitFbaInboundPlan(@WebParam(name = "planId") int planId,
														   @WebParam(name = "shopId") int shopId, @WebParam(name = "operatorId") int operatorId);
