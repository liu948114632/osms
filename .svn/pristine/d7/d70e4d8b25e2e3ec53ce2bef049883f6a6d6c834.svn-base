...
/**
 * <p>
 * Java class for osmsStorageFreeze complex type.
 * 
 * <p>
...
@XmlType(name = "osmsStorageFreeze", propOrder = { "availableQuantity", "productCode", "productId",
		"realFreezeQuantity", "shouldFreezeQuantity" })
