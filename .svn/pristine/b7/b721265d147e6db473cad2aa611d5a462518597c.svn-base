...
/**
 * <p>
 * Java class for findProductsResponse complex type.
 * 
 * <p>
...
@XmlType(name = "findProductsResponse", propOrder = { "_return" })
public class FindProductsResponse {
	 ...
	 * 
	 * @return possible object is {@link PageList }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link PageList }
	 * 
	 */
