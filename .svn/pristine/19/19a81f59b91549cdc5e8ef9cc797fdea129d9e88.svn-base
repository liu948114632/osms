...
@XmlType(name = "property", propOrder = { "cnName", "description", "id", "isDecoration", "isElectronic", "name",
		"propertyValues" })
public class Property {
	...
	/**
	 * Gets the value of the isDecoration property.
	 * 
	...
	/**
	 * Sets the value of the isDecoration property.
	 * 
	 * @param value
