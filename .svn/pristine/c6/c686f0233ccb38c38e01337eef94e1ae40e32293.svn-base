...
public interface OrderService extends IBaseOrder{
	 ...
	 * @throws BussinessException
	 */
	public void updateOrder(int orderId, String remark, boolean sendTag,int isQualityInspection, String operator) throws BussinessException;
	...
	public enum OrderAmazonStatus{
		...
		WORKING(3,"卖家已创建货件，但尚未发货"),
		SHIPPED(5,"承运人已取件"),
		IN_TRANSIT(7,"承运人已通知 亚马逊配送中心 知晓货件的存在"),
		CHECKED_IN(9,"货件已在 亚马逊配送中心 的收货区登记"),
		...
		OrderAmazonStatus(int statusCode, String message) {
