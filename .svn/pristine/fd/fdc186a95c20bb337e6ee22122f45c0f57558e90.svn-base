...
/**
 * <p>
 * Java class for getAmount complex type.
 * 
 * <p>
 ...
 *       &lt;sequence>
 *         &lt;element name="arg0" type="{http://out.webservice.dms.itecheasy.com/}shippingAmount" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "getAmount", propOrder = { "arg0", "arg1" })
public class GetAmount {

	protected List<ShippingAmount> arg0;
	 ...
	 * 
	 */
	public List<ShippingAmount> getArg0() {
		if (arg0 == null) {
			arg0 = new ArrayList<ShippingAmount>();
		}
		return this.arg0;
	}
