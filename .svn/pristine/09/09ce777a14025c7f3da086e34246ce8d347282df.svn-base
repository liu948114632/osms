...
public class LineOfBusinessVO {
     ...
     * 业务线绑定的店铺的Id
     */
    private List<Integer> businessBindShopIdList;
    ...
    public List<Integer> getBusinessBindShopIdList() {
        return businessBindShopIdList;
    }

    public void setBusinessBindShopIdList(List<Integer> businessBindShopIdList) {
        this.businessBindShopIdList = businessBindShopIdList;
    }
